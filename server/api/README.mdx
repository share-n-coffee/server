...
### Советую всем, кто будет работать с API, установить программу Postman, в которой можно сразу же и проверить работу API

[А по этой ссылке доступна свежая версия документации API](https://documenter.getpostman.com/view/7419944/S1Lx1ouZ)
